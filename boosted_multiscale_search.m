function [max_responses, max_scales] = boosted_multiscale_search(image, scales,classifiers, weak_classifiers,face_size, result_number)
...
for scale = scales;
    ...
    temp_result = apply_classifier_aux(scaled_image, classifiers,weak_classifiers, face_size);
